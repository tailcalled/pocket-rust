...
fn check_function(
    ...
    let cfg_move_sites: Vec<(crate::ast::NodeId, String)>;
    {
        ...
        let (param_types, expr_types, method_resolutions, call_resolutions, bare_closure_calls, type_params, type_param_bounds, pattern_ergo, lifetime_params, lifetime_predicates, const_uses, fn_item_addrs, dyn_method_calls) =
